                  ...
                  <div class="x_title">
                    ...
                    <div class="x_content">
                      ...
                      <div class="x_panel ">
                        <div class="x_content">
                        <div class="row">
                              <h2>Select Unavailable dates (this affects to appoinments of citizens)</h2>
                            </div>
                          <div class="row mt-3">
                            <div class="col-4 ml-auto">
                            <input type="hidden" class="form-control" id="storedates" name="dates">
                          <div class="input-prepend input-group" id="datePick"></div>
                                  
                            </div>
                            <div class="col-6">
                              <h6>Selected Dates</h6>
                            <textarea name="" class="form-control" cols="1" rows="3" id="showdates"></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
